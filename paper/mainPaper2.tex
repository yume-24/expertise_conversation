...
Figure~\ref{fig:centroid-distances} shows the distances between speaker centroids. Centroid distances tended to decrease as expertise decreased, with expert-expert conversations having the lowest centroid distances. This indicates that as partner expertise increases, the overall semantic usage of the two interlocutors becomes progressively more similar. This would make sense, as expert-expert pairs(for example) are operating very much “in the same space,”  with access to the same concepts and by extension, vocabulary, as opposed to expert-novice pairs where novices have limited ***** in the conceptual space. Expert-novice conversations tend to require extensive scaffolding, as children often have barely any knowledge of the concepts being discussed. The concepts of discussion have to be explained with different, more digestible language.  The expert in this case is required to scaffold, with the aim of getting the novice “on the same page/in the same kind of space(information organization).” The novice may say things that are a bit “off” since they have not acquired the proper vocabulary for the topic, making the average embedding(centroid) of the speakers further. Experts do not have to undergo this scaffolding process(more semantic precision).
...
Figures~\ref{fig:radial-distance-median} and~\ref{fig:radial-distance-q90} show the median and 90th-percentile radial distances, respectively. Median radial distances tended to decrease, and q90 radial distances tended to increase as partner gap decreased. This indicates expert distributions tended to have slightly more concentration near the centroid (which could indicate high specificity, but could be confounded with redundancy), but also explored enough relative to the conversational center(or it could be something else) to have further points in the periphery. Novices, on the other hand, had slightly less concentration near the centroid and closer peripheral embeddings, but the differences between expert-expert and expert-novice dispersions were not too significant.
...
Figure~\ref{fig:participation-ratio} shows participation ratio across partner expertise levels. Participation ratio tended to increase as expertise gap decreased, indicating higher conversation dimensionality at higher levels of conversation (the result was statistically significant when accounting for topic dependencies and number of utterances). Even with little difference in overall dispersion/variation, the experts had significantly higher PR values, indicating that even with similar overall dispersions, the variation was structured significantly differently than in expert-novice conversations. Expert-expert pairs were able to more confidently and precisely expand the conversation in controlled ways(they can say more things in more controlled ways). In expert-novice conversations, even though the expert could take the conversation in more directions, their semantic trajectories are limited as they have to scaffold for the novice speaker. This leads to the PR values for expert-novice being significantly lower, even with experts leading the conversations.
